...
-- One place for every WhisperThemAll chat line: a yellow prefix, plain white
-- text, and three status colours for the lead word of each message.
...
-- One status line per event: the addon tag, then the whole summary. Inline
-- status colours in `text` carry their own codes and show through.
